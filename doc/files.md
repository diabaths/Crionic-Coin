...
* crionic.conf: contains configuration settings for crionicd or crionic-qt
* crionicd.pid: stores the process id of crionicd while running
...
* debug.log: contains debug information and general logging generated by crionicd or crionic-qt
