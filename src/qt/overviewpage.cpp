...
#include <qt/hivetablemodel.h>  // Crionic: Hive
#include <qt/hivedialog.h>      // Crionic: Hive: For formatLargeNoLocale()
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    if(model && model->getOptionsModel())
    {
        ...
        // Crionic: Hive: Connect summary updater
...
// Crionic: Hive: Update the hive summary
...
void OverviewPage::updateDisplayUnit()
{
    if(walletModel && walletModel->getOptionsModel())
    {
        ...
        // Crionic: Hive: Update CAmounts in hive summary
        ui->rewardsPaidLabel->setText(
            BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rewardsPaid)
            + " "
            + BitcoinUnits::shortName(walletModel->getOptionsModel()->getDisplayUnit())
...
// Crionic: Hive: Handle bee button click
