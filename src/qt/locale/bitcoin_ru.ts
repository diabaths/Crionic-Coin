...
<context>
    ...
    <message>
        ...
        <translation>Выберите адрес для отправки CRNC-монет</translation>
    </message>
    <message>
        <source>Choose the address to receive coins with</source>
        <translation>Выберите адрес для получения CRNC-монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Это ваши адреса Crionic для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой CRNC-монет.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Crionic для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Предупреждение: если вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ CRNC-МОНЕТЫ&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сейчас %1 закроется для завершения процесса шифрования. Помните, что шифрование вашего бумажника не может полностью защитить ваши CRNC-монеты от кражи с помощью инфицирования вашего компьютера вредоносным ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Crionic</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Crionic</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения с помощью вашего адреса Crionic, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Crionic addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Crionic</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и crionic-ссылки)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть crionic: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активных соединений с сетью Crionic</numerusform><numerusform>%n активных соединений с сетью Crionic</numerusform><numerusform>%n активных соединений с сетью Crionic</numerusform><numerusform>%n активных соединений с сетью Crionic</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла неисправимая ошибка. Crionic не может безопасно продолжать работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным Crionic-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1 будет загружать и хранить копию цепочки блоков Crionic.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Попытка потратить CRNC-монеты из ещё неотображённых транзакций будет отвергнута сетью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Crionic-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Crionic через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Crionic через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Crionic через прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью Crionic после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить crionic: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть связано с неверным адресом Crionic или неправильными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Crionic (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Crionic.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Плату "только минимальной комиссии" рекомендуется использовать пока объём транзакции меньше, чем свободное место в блоках. Учтите, однако, что такая транзакция может никогда не подтвердиться, если спрос на crionic транзакции превысит возможности сети по их обработке.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Crionic</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Crionic, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>С отправляемой суммы будет удержана комиссия. Получателю придёт меньше CRNC-монет, чем вы вводите в поле количества для отправки. Если выбрано несколько получателей, комиссия распределится поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К crionic: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Crionic.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом Crionic</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Crionic, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Crionic address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Crionic</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
