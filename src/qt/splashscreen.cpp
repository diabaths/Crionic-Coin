    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int paddingRight            = 10;   // Crionic: Fix ugly spacing on splash screen
    int paddingTop              = 50;
    ...
    QString titleText       = tr("Crionic Coin");  // Crionic: Show the pretty name, not package name
    ...
    // Crionic: Adjusted to show whole logo
    ...
    // Crionic: Faster, stronger, better !
    pixPaint.setFont(QFont(font, 15*fontFactor));
