...
#include <policy/policy.h>  // Crionic: Hive: For GetVirtualTransactionSize

WalletModel::WalletModel(const PlatformStyle *platformStyle, CWallet *_wallet, OptionsModel *_optionsModel, QObject *parent) :
    QObject(parent), wallet(_wallet), optionsModel(_optionsModel), addressTableModel(0),
    transactionTableModel(0),
    recentRequestsTableModel(0),
    hiveTableModel(0),  // Crionic: Hive
    ...
    cachedNumBlocks(0)
{
    ...
    hiveTableModel = new HiveTableModel(platformStyle, wallet, this);  // Crionic: Hive
...
WalletModel::UnlockContext WalletModel::requestUnlock(bool hiveOnly)
{
    ...
    // Crionic: Hive: Support unlock for hive mining only
    ...
    return UnlockContext(this, valid, was_locked && !fWalletUnlockHiveMiningOnly); // Crionic: Hive: Support unlock for hive mining only
}
