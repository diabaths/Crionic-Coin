...
LITECOINCASHD=${LITECOINCASHD:-$SRCDIR/crionicd}
LITECOINCASHCLI=${LITECOINCASHCLI:-$SRCDIR/crionic-cli}
LITECOINCASHTX=${LITECOINCASHTX:-$SRCDIR/crionic-tx}
LITECOINCASHQT=${LITECOINCASHQT:-$SRCDIR/qt/crionic-qt}
